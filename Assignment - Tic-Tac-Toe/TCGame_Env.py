...
class TicTacToe():
    ...
    def is_winning(self, curr_state):
        ...
        # "Check sum of diagonal from top to bottom == 15"
        if (curr_state[0] + curr_state[4] + curr_state[8]) == 15:
            return True
        # "Check sum of diagonal from bottom to top == 15"
    ...
    def step(self, curr_state, curr_action):
        ...
        is_terminal, terminal_status = self.is_terminal(new_curr_state)
        ...
        return (new_curr_state, reward, is_terminal)
